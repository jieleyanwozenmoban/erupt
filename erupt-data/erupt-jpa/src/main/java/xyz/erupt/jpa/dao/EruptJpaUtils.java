...
public class EruptJpaUtils {
    ...
    public static String generateEruptJpaHql(EruptModel eruptModel, String cols, EruptQuery query, boolean countSql) {
        ...
        if (StringUtils.isNotBlank(cols)) {
            ...
            // Fix the defect where the query result is incorrect when configuring multi-level display for the view
            // If the view is configured for multi-level display, a manual left join association must be performed; otherwise, the query result will be incomplete due to the cross join automatically generated by JPA.
            // Here, call the rewritten generateEruptJoinHql method
    ...
    // In the case of a left join, it is necessary to specify the table information, and this information is generated through this method.
